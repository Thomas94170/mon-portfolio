...
function isInMiddlewareFile(parser) {
    var ref, ref2;
    return ((ref = parser.state.current) === null || ref === void 0 ? void 0 : ref.layer) === 'middleware' && /middleware\.\w+$/.test((ref2 = parser.state.current) === null || ref2 === void 0 ? void 0 : ref2.rawRequest);
}
